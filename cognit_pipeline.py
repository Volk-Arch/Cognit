...
Типы стадий:
  rwkv   — навигация (мемо уже есть из RWKV handoff, просто вставляется)
...
Параметры верхнего уровня:
  passes — сколько раз прогнать агентов (default 1).
           ...
           RWKV и coder всегда запускаются один раз независимо от passes.
    ...
    "stages": [
        {
            ...
            "type":    "rwkv",
            "enabled": True,
            "comment": "Мемо от RWKV: какие файлы, где смотреть, зависимости"
        },
        {
            "id":      "context",
            "type":    "agent",
        ...
        },
        {
            ...
            "type":    "coder",
            "enabled": True,
            "role":    "Напиши unified diff для реализации задачи. "
                       "Для нового файла используй '--- /dev/null'. "
                       "Только ```diff блок, без объяснений.",
